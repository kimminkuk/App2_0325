...
namespace App2_0325
{
    ...
    class html_addr
    {
        ...
        public string html_HtmlDoc_page1_v2(string jusik_code, ref stock_v2[] stock_10days)
        {
            //Initial
            Global_days GG = new Global_days();
            stock_v2[] stock_page1 = new stock_v2[GG._days];
            string put = "";
            stock_page1 = stock_10days; //ref
        ...
        public string html_HtmlDoc_page2_v2(string jusik_code, ref stock_v2[] stock_20days)
        {
            //Initial
            Global_days GG = new Global_days();
            stock_v2[] stock_page2 = new stock_v2[GG._days];
            string put = "";
            stock_page2 = stock_20days; //ref
        ...
        public string html_HtmlDoc_page3_v2(string jusik_code, ref stock_v2[] stock_30days)
        {
            //Initial
            Global_days GG = new Global_days();
            stock_v2[] stock_page3 = new stock_v2[GG._days];
            string put = "";
            stock_page3 = stock_30days; //ref
        ...
        public string html_HtmlDoc_page4_v2(string jusik_code, ref stock_v2[] stock_40days)
        {
            //Initial
            Global_days GG = new Global_days();
            stock_v2[] stock_page4 = new stock_v2[GG._days];
            string put = "";
            stock_page4 = stock_40days; //ref
        ...
        public string html_HtmlDoc_page5_v2(string jusik_code, ref stock_v2[] stock_50days)
        {
            //Initial
            Global_days GG = new Global_days();
            stock_v2[] stock_page5 = new stock_v2[GG._days];
            string put = "";
            stock_page5 = stock_50days; //ref
